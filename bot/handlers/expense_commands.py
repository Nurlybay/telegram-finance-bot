...
async def cmd_start(
    ...
    await message.answer(
        "Привет! Я бот для анализа твоих расходов. Нажми на кнопку ниже, чтобы увидеть анализ своих трат. Записывай мне аудио о всех твоих затратах, а я буду ввести твои финансы. Вообщем начинай а дальше все увидем",
